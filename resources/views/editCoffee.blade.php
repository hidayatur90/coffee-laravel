...
@section('content')
    ...
    <div class="container mt-4">
        <div class="header text-center fst-italic">
            <h3>Edit Coffee of {{ $coffee->name }}</h3>
            <p>fill in the name, quantity and price of the <span><strong>{{ $coffee->name }}</strong></span> coffee product</p>
        </div>
        <div class="form">
            <form action="/editCoffee/update/{{ $coffee->id }}" method="POST">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                {{-- Name of Coffee --}}
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 col-md-9 col-xl-10">
                        <input type="number" class="form-control" min="0" max="99999" name="stock"
                            id="stock" value="{{ $coffee->unit_stock }}" placeholder="Units in Stock" autocomplete="off" required
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 col-md-9 col-xl-10">
                        <input type="number" class="form-control" min="0" max="9999999999" step="500"
                            name="price" id="price" value="{{ $coffee->unit_price }}" placeholder="Units in Price" autocomplete="off"
